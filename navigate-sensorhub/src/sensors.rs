...
// Legacy sensor drivers (direct implementations)
#[cfg(feature = "bmp388")]
pub mod bmp388;
...
// Platform-agnostic embedded-hal based adapters
pub mod adapters;
...
pub fn create_sensor_driver(
    ...
    match driver {
        // Platform-agnostic embedded-hal based drivers
        #[cfg(feature = "icm426xx-driver")]
        "icm426xx" => Ok(Box::new(adapters::icm426xx::Icm426xxAdapter::new(
            id, address, bus_id,
        ))),

        // Legacy drivers (will be migrated to embedded-hal)
        #[cfg(feature = "lsm6dsl")]
